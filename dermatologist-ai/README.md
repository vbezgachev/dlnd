...
[image8]: ./images/final_confusion_matrix.png "Final confusion matrix"
...
```text
Category 1 Score: 0.690
Category 2 Score: 0.700
Category 3 Score: 0.695
```  

![Final ROC curve][image7]
![Final confusion matrix][image8]
